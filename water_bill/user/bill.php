                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ul class="nav nav-pills nav-justified">
                            ...
                            <li class=""><a href="#due" data-toggle="pill">Pay bill</a>
                            </li>
                        </ul>
                                    ...
                                    <table class="table table-hover table-striped table-bordered table-condensed" style="background: white;">
                                        ...
                                        <tbody>
                                            ...
                                            while($row = mysqli_fetch_assoc($result)){
                                                $my_control_number = $row['uid'] + 203040974;
                                            ?>
                                                <tr>
                                                    <td height="50">
                                                        <?php echo $my_control_number; ?>
                                                    </td>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo 'MN_'.$id.'00Tz' ?></td>

                                                    <input type="hidden" name="payable" value=<?php echo $row['payable'] ?> >
                                                    <td><?php echo 'Tsh '.$row['payable'] ?></td>

                                                    <td>
                                                    <button class="btn btn-success form-control" data-toggle="modal"  data-target="#PAY">Verify Payment</button>
                                                    <!--TRANSACT BILL MODAL -->
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center">
                                                                    <h4>ARE YOU SURE?</h4>
                                                                    <p>Do it before <?php echo $row['ddate']; ?> or DUES will served!!</p><br>
                                                                        <div class="row col-md-12 my-4">
                                                                            <div class=" form-group col-md-8">
                                                                                <h4>Your Control Number</h4>
                                                                            </div>
                                                                            <div class=" form-group col-md-4">
                                                                                <input type="text" class="form-control" value="<?php echo $my_control_number; ?>" readonly>   
                                                                            </div>
                                                                        </div>
