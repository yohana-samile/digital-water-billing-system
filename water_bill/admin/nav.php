...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand text-white" href="index.php" style="color: white"> Digital Water Billing</a>
    </div>
    <!-- /.navbar-header -->
    ...
    <ul class="nav navbar-right top-nav">
        <li class="dropdown">
            <?php 
                echo "<a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\"><i class=\"fa fa-user\"></i> MANAGER <b class=\"caret\"></b></a> ";
             ?>
