                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td height="50">
                                                        <?php
                                                            if ($row['my_control_number'] == 0) {
                                                                 
                                                             }
                                                             else{
                                                               echo $row['my_control_number']; 
                                                             } 
                                                        ?>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <button class="btn btn-success form-control" data-toggle="modal"  data-target="#PAY">Generate Control No, And Pay</button>
                                                    <!--TRANSACT BILL MODAL -->
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center">
                                                                    ...
                                                                    <?php
                                                                        $getno = $con->query("SELECT my_control_number FROM user where uid={$id} ");
                                                                            $myno = mysqli_num_rows($getno);
                                                                        if ($myno = 'no') { ?>
                                                                            <div class="row col-md-12">
                                                                                <div class=" form-group col-md-8">
                                                                                    <input type="text" class="form-control" max="8" placeholder="Enter Contro Number" required="" name="my_control_number" autocomplete="off">   
                                                                                </div>
                                                                                <div class="form-group col-md-4">
                                                                                    <img src="get_control_number.php" style="width: 120px;">
                                                                                </div>
                                                                            </div>
                                                                        <?php }
                                                                         else{
                                                                            echo $myno['my_control_number'];
